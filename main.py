...
class DIPApp(ctk.CTk):
    ...
    def __init__(self):
        ...
        self.image_path = None  # Path to the current image
        self.original_image = None  # Original loaded image
        self.images = {}  # Dictionary to store processed images
        self.current_thresh_mode = "Basic Global"  # Default threshold mode
        self.setup_layout()  # Set up the GUI layout
    ...
    def setup_layout(self):
        ...
        self.upload_button = ctk.CTkButton(self, text="\U0001F4C2 Upload Image", command=self.load_image)
        self.upload_button.pack(pady=10)

        # Scrollable frame for thumbnail display
        self.thumbnail_frame_container = ctk.CTkScrollableFrame(self, height=220, orientation="horizontal")
        ...
        self.options_frame = ctk.CTkFrame(self, height=160)
        self.options_frame.pack(pady=10, fill="x")

        # Label for displaying main image
        self.main_image_label = ctk.CTkLabel(self, text="")
